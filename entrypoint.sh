...
jhsingle-native-proxy --destport $destport --authtype none streamlit run /home/jovyan/app.py {--}server.port {port} {--}server.headless True {--}server.enableCORS False --port $port
